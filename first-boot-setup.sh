...
emerge --ask --verbose \
  ...
  app-misc/fastfetch \
  x11-libs/libnotify \
  app-misc/brightnessctl gui-wm/hyprland-contrib gui-apps/wl-mirror app-shells/fzf media-sound/pavucontrol gui-apps/qt6ct x11-themes/kvantum app-portage/eix
...
emerge --ask --verbose app-editors/neovim google-chrome net-im/mattermost-desktop-bin gimp texstudio texlive inkscape vscode mpv pcmanfm-qt sys-process/btop obs-studio media-gfx/imv
